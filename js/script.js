...
// 	$('#'+leaders[i].id).click(function(){
// 		console.log("clicking works");
// 		console.log(leaders[i].id);
// 		$("#"+leaders[i].id).html("Hmn." + leaders[i].name + " " + leaders[i].phoneNumber);
// 		var clicks = $(this).data('clicks');
// 		if (clicks) {
// 			$(this).html("Hmn." + leaders[i].name);
// 		}
// 		else{
// 			$(this).html("Hmn." + leaders[i].name + " " + leaders[i].phoneNumber);
